...
<script>
    console.log('Scripts de horarios');
</script>
@if (session('success'))
    <script>
        console.log('Scripts de horarios');
...
<script>
    $(document).ready(function() {
        ...
        var choicesEmployee = new Choices(employeeSelect);
        var choicesSchedule = new Choices(scheduleSelect);
    });

    document.addEventListener('DOMContentLoaded', function() {
        activateElementById('horario');
    });
</script>
